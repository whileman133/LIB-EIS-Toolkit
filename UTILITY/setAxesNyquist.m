...
if isempty(p.aspect)
    if isstruct(fig.UserData) && ...
        ...
        strcmp(fig.UserData.origin__,'thesisFormat')
        % Figure processed by thesisFormat; use appropriate aspect ratio.
        aspect = fig.UserData.arg.AxesAspectRatio;
    else
...
axmetadata = ax.UserData;
if isstruct(axmetadata)&&...
   isfield(axmetadata,'origin__')&&...
   strcmp(axmetadata.origin__,'addInset')
  % Axes generated by addInset() - use xpsan / yspan as data limits.
  xdata = axmetadata.xspan;
  ydata = axmetadata.yspan;
end
